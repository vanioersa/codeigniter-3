            ...
            <div class='card w-50 m-auto p-3'>
                ...
                <?php foreach ($pembayaran as $data_pembayaran) : ?>
                    <form action="<?php echo base_url('keuangan/aksi_ubah_pembayaran') ?>" method="post" enctype="multipart/from-data">
                        <input type="hidden" name="id_pembayaran" value="<?php echo $data_pembayaran->id_pembayaran ?>">
                        ...
                        <div style="margin-left: 25%;" class="col-6">
                            ...
                            <input type="number" class="form-control" id="tottal_pembayaran" name="tottal_pembayaran">
                        </div>
