...
<body style="background-image: url('https://pbs.twimg.com/profile_images/929918269359669248/O8WCn1LA_400x400.jpg');">
...
<div class="row col-sm-10 mb-sm-0" style="margin-top: 25px;">
    ...
    <div class="col">
        ...
        <div class="card-header">Jumlah Kelas</div>
            <div class="card-body">
                <p class="card-text"><?php echo $kelas ?>  <i class="fa-solid fa-user-tie"></i></p>
