...
<div class="d-flex">
  ...
  <div class="container py-3 h-auto">
      ...
      <thead>
        <br>
      <a style="margin-left: 75%;" href="<?php echo base_url('admin/tambah_siswa')?>"><button type="submit" class="btn btn-primary w-25" name="submit"><i class="fa-solid fa-folder-plus"></i> Tambah</button></a>
      <br><br>
        <tr>
        ...
        <tbody classs="table-grup-divider">
          ...
          <tr>
            ...
            <td style="text-align: center;">
                ...
                <button style="margin-left: 10px;" onclick="hapus(<?php echo $row-> id_siswa ?>)"
