    ...
    <div class="container py-3 h-auto">
      ...
      <table class="table table-info">
        <thead>
          ...
          <a style="margin-left: 740px;" href="<?php echo base_url('admin/tambah_guru') ?>"><button type="submit" class="btn btn-primary w-25" name="submit"><i class="fa-solid fa-folder-plus"></i> Tambah</button></a>
          <br><br>
          <center>
            <tr>
          ...
          foreach ($guru as $row) : $no++ ?>
            <tr>
              ...
              <td style="text-align: center;">
                ...
                <button style="margin-left: 10px;" onclick="hapus(<?php echo $row->id_guru ?>)" class="btn btn-danger"><i class="fa-solid fa-delete-left"></i></button>
              </td>
            </tr>
            </center>
          <?php endforeach ?>
